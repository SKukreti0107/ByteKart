  ...
  return (
    <StorefrontLayout>
      <main className="w-full space-y-6">
              ...
              return (
                <div
                  ...
                  className={`rounded-full px-4 py-2 text-sm font-bold ${
                    active ? 'bg-baby-green text-matcha-deep' : 'bg-off-white text-charcoal-dark/50'
                  }`}
                >
                  {stepNumber}. {step}
                </div>
        ...
        {placed ? (
          <section className="window-container border-none bg-baby-green/50 p-5 text-center">
            <h2 className="text-2xl font-bold text-matcha-deep">Order placed successfully</h2>
            <p className="mt-1 text-sm font-semibold text-charcoal-dark/70">Confirmation and shipment updates have been sent to your email.</p>
          </section>
        ) : null}
      </main>
    </StorefrontLayout>
