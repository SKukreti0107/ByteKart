export default function ExtraCards() {
    return (
        <div className="space-y-8">
            <section className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                <div className="window-container group relative overflow-hidden border-0 bg-white p-6 shadow-lg md:p-10">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="mb-4 text-3xl font-bold text-[var(--charcoal-dark)] md:text-4xl">Carbon-Zero Hardware</h3>
                        ...
                        <button className="btn-glow-dark rounded-xl bg-[var(--charcoal-dark)] px-6 py-3 font-bold text-white transition-all hover:bg-[var(--matcha-deep)] md:px-8">
                            Learn Our Mission
                        </button>
                    </div>
                </div>
                ...
                <div className="window-container relative flex flex-col items-start justify-center overflow-hidden border-0 bg-white p-6 shadow-lg md:p-10">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="mb-4 text-3xl font-bold text-[var(--charcoal-dark)] md:text-4xl">Matcha Bundle 40% OFF</h3>
                        <p className="mb-8 max-w-sm font-medium text-[color:var(--charcoal-dark)]/70">
                            Get the keyboard, mouse, and headset in our signature Matcha theme for a fraction of the price.
                        </p>
                        <button className="btn-glow-dark rounded-xl bg-[var(--matcha-deep)] px-6 py-3 font-bold text-white shadow-md transition-all hover:shadow-lg md:px-8">
                            Claim Bundle
                        </button>
                    </div>
                </div>
            ...
            <section className="flex flex-col items-start gap-10 rounded-[var(--radius-squish)] border-[4px] border-white/40 bg-[var(--charcoal-dark)] p-10 text-white shadow-[var(--shadow-window-sep)] md:p-14 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex-1 space-y-6">
                    <h2 className="text-3xl leading-tight font-bold sm:text-4xl md:text-5xl">
                        Join the <span className="text-[var(--baby-green)] drop-shadow-[0_0_15px_rgba(198,220,186,0.35)]">Green Tech</span> Revolution.
                    </h2>
                ...
                <div className="w-full rounded-3xl border border-white/10 bg-white/5 p-3 backdrop-blur-sm lg:w-auto">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                        <input
                            ...
                            className="w-full min-w-0 rounded-2xl border border-white/20 bg-white/10 px-6 py-4 text-white placeholder:text-white/40 focus:border-[var(--baby-green)] focus:ring-2 focus:ring-[var(--baby-green)] sm:min-w-[320px]"
                        />
                        <button className="btn-glow rounded-2xl bg-[var(--baby-green)] px-8 py-4 font-bold whitespace-nowrap text-[var(--charcoal-dark)] transition-all hover:bg-white">
                            Subscribe
                        </button>
                    </div>
                </div>
